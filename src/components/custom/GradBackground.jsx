...
export function GradientBackground({ containerClassName }) {
    return (
        (<BackgroundGradientAnimation containerClassName={cn("bg-none overflow-visible", containerClassName)} className={""}>
            {/* <div
